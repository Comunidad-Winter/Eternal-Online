...
With UserList(UserIndex)
    ...
    Select Case UserRaza
        Case eRaza.Humano
            .Invent.Object(Slot).ObjIndex = 9
        Case eRaza.Elfo
            .Invent.Object(Slot).ObjIndex = 10
        Case eRaza.Drow
            .Invent.Object(Slot).ObjIndex = 11
        Case eRaza.Enano
            .Invent.Object(Slot).ObjIndex = 12
        Case eRaza.Gnomo
            .Invent.Object(Slot).ObjIndex = 12
    End Select
    ...
    Select Case UserClase
        Case eClass.Hunter
            ' Arco (Newbie)
            .Invent.Object(Slot).ObjIndex = 19
        Case eClass.Mage
            ' Baculo (Newbie)
            .Invent.Object(Slot).ObjIndex = 4
        Case Else
            ' Daga (Newbie)
            .Invent.Object(Slot).ObjIndex = 3
    End Select
    ...
    .Invent.WeaponEqpObjIndex = .Invent.Object(Slot).ObjIndex '    .Invent.WeaponEqpSlot = Slot
    ...
    If UserClase = eClass.Hunter Then
        Slot = Slot + 1
       .Invent.Object(Slot).ObjIndex = 20
       .Invent.Object(Slot).Amount = 150

        ' Equipo flechas
        .Invent.Object(Slot).Equipped = 1
        .Invent.MunicionEqpSlot = Slot
        .Invent.MunicionEqpObjIndex = 20
    End If

    ' Manzanas (Newbie)
    Slot = Slot + 1
    .Invent.Object(Slot).ObjIndex = 21
    .Invent.Object(Slot).Amount = 100

    ' Jugos (Nwbie)
    Slot = Slot + 1
    .Invent.Object(Slot).ObjIndex = 22
    .Invent.Object(Slot).Amount = 100
...
With UserList(UserIndex)
    ...
    Call WriteConsoleMsg(UserIndex, "Servidor> Bienvenido " & .name & " a Eternal Online actualmente hay " & NumUsers & " usuarios conectados, y el record maximo fue " & recordusuarios & " usuarios.", FontTypeNames.FONTTYPE_SERVER)
    Call WriteConsoleMsg(UserIndex, "Servidor> Recuerda que esta es una versión BETA-TESTER, cualquier error o problema pueden reportarlo a los administradores del juego.", FontTypeNames.FONTTYPE_SERVER)
