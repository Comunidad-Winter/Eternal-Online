...
With UserList(UserIndex)
    Select Case .Genero
        Case eGenero.Hombre
            Select Case .raza
                Case eRaza.Humano
                    CuerpoDesnudo = HUMANO_H_CUERPO_DESNUDO
                Case eRaza.Drow
                    CuerpoDesnudo = DROW_H_CUERPO_DESNUDO
                Case eRaza.Elfo
                    CuerpoDesnudo = ELFO_H_CUERPO_DESNUDO
                Case eRaza.Gnomo
                    CuerpoDesnudo = GNOMO_H_CUERPO_DESNUDO
                Case eRaza.Enano
                    CuerpoDesnudo = ENANO_H_CUERPO_DESNUDO
            End Select
        Case eGenero.Mujer
            Select Case .raza
                Case eRaza.Humano
                    CuerpoDesnudo = HUMANO_M_CUERPO_DESNUDO
                Case eRaza.Drow
                    CuerpoDesnudo = DROW_M_CUERPO_DESNUDO
                Case eRaza.Elfo
                    CuerpoDesnudo = ELFO_M_CUERPO_DESNUDO
                Case eRaza.Gnomo
                    CuerpoDesnudo = GNOMO_M_CUERPO_DESNUDO
                Case eRaza.Enano
                    CuerpoDesnudo = ENANO_M_CUERPO_DESNUDO
            End Select
    End Select
...
'***************************************************
    ...
    If Map > 0 And Map < NumMaps + 1 And X > 0 And X < 101 And Y > 0 And Y < 101 Then
        With MapData(Map, X, Y)
            If ((.Graphic(1) >= 21781 And .Graphic(1) <= 21796) Or _
            (.Graphic(1) >= 21797 And .Graphic(1) <= 21812)) And _
               .Graphic(2) = 0 Then
                    HayAgua = True
            Else
                    HayAgua = False
