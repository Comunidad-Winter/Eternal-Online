...
Public Const iFragataFantasmal = 28
Public Const iFragataReal = 20
Public Const iFragataCaos = 21
Public Const iBarca = 19
Public Const iGalera = 23
Public Const iGaleon = 27
Public Const iBarcaCiuda = 15
Public Const iBarcaPk = 16
Public Const iGaleraCiuda = 20
Public Const iGaleraPk = 21
Public Const iGaleonCiuda = 24
Public Const iGaleonPk = 26
...
Public Enum ParticleIDs
    M_NEWBIE = 42
    M_VERSION_TWO = 81 'lvl 15-24
    M_VERSION_THREE = 41 'lvl 25-34
    M_VERSION_FOUR = 107 'lvl 35-50
End Enum
...
'%%%%%%%%%% CONSTANTES DE INDICES %%%%%%%%%%%%%%%
Public Const iCuerpoMuerto As Integer = 13
Public Const iCabezaMuerto As Integer = 315


Public Const iORO As Byte = 23
Public Const iOROMid As Integer = 280
Public Const iOROLow As Integer = 281
...
Public Const SND_GRILLO As Byte = 22
Public Const SND_GRILLO2 As Byte = 29
Public Const SND_SACARARMA As Byte = 25
Public Const SND_ARMADURAS As Integer = 285
...
Public Const SND_POCION As Integer = 286
...
Public Onirem As WorldPos
Public Osurac As WorldPos
