...
On Error GoTo ErrorHandler
    ...
    With UserList(UserIndex)
        ...
        If IsAdminInvisible Then
            Call EnviarDatosASlot(UserIndex, PrepareMessageCharacterRemove(.Char.CharIndex, False))
        Else
            'Le mandamos el mensaje para que borre el personaje a los clientes que estén cerca
            Call SendData(SendTarget.ToPCArea, UserIndex, PrepareMessageCharacterRemove(.Char.CharIndex, False))
        End If
    ...
    With UserList(UserIndex)
        ...
        If InMapBounds(Map, X, Y) Then
            ...
            If Not toMap Then
                ...
                Call WriteCharacterCreate(sndIndex, 6, .Char.body, .Char.Head, .Char.heading, _
    ...
    With UserList(UserIndex)
        Do While .Stats.Exp >= .Stats.ELU
            ...
            If .Stats.ELV >= STAT_MAXELV Then
                .Stats.Exp = 0
                .Stats.ELU = 0
                Call WriteUpdateUserStats(UserIndex) '// actualizame al llegar al maximo pls
                Exit Sub
            End If
        ...
        If MapInfo(.Pos.Map).LevelMAX > 0 Then
            If MapInfo(.Pos.Map).LevelMAX < .Stats.ELV Then
                Call WarpUserChar(UserIndex, 1, 50, 50, True)
                Call WriteConsoleMsg(UserIndex, "Debes abandonar este mapa.", FontTypeNames.FONTTYPE_INFO)
            End If
        End If
        ...
        If .flags.Hambre = 0 And .flags.Sed = 0 Then
            With .Stats
                ...
                If .ExpSkills(Skill) >= .EluSkills(Skill) Then
                    ...
                    Call WriteConsoleMsg(UserIndex, "¡Has ganado 50 puntos de experiencia!", FontTypeNames.FONTTYPE_EXP)
...
'**************************************************************
    ...
    With UserList(UserIndex)
        ...
        'Seguis Envenenado al pasar de mapa.
...
'***************************************************
    If newHome < eCiudad.cOnirem Or newHome > cOsurac Then Exit Sub
