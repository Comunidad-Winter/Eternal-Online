...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.path & "\Resources\Interface\VentanaEstadisticas.jpg")
...
Private Sub imgCerrar_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If imgCerrar.Tag = 1 Then
        imgCerrar.Picture = LoadPicture(App.path & "\Resources\Interface\BotonCerrarApretadoEstadisticas.jpg")
        imgCerrar.Tag = 0
    End If
