...
Private Sub LoadBackGround()
    ...
    Select Case T
        Case TIPO.ALIANZA
            Me.Picture = LoadPicture(DirInterface & "VentanaPropuestaAlianza.jpg")
            
        Case TIPO.PAZ
            Me.Picture = LoadPicture(DirInterface & "VentanaPropuestaPaz.jpg")
            
        Case TIPO.RECHAZOPJ
            Me.Picture = LoadPicture(DirInterface & "VentanaMotivoRechazo.jpg")
