...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(DirInterface & "VentanaCambioMOTD.jpg")
...
Private Sub LoadButtons()
    ...
    Set picNegrita = LoadPicture(DirInterface & "OpcionPrendidaN.jpg")
    Set picCursiva = LoadPicture(DirInterface & "OpcionPrendidaC.jpg")
End Sub
