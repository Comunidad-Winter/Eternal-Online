...
'***************************************************
    ...
    If NoRes Then
        CambiarResolucion = (oldResWidth < Config_Inicio.ResolutionX Or oldResHeight < Config_Inicio.ResolutionY)
    Else
        CambiarResolucion = (oldResWidth <> Config_Inicio.ResolutionX Or oldResHeight <> Config_Inicio.ResolutionY)
    End If
    ...
    If CambiarResolucion Then
        ...
        With MidevM
            ...
            .dmPelsWidth = Config_Inicio.ResolutionX
            .dmPelsHeight = Config_Inicio.ResolutionY
            .dmBitsPerPel = 32
        End With
