...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.path & "\Resources\Interface\Boveda.jpg")
...
Private Sub LoadButtons()
    ...
    'CmdMoverBov(1).Picture = LoadPicture(App.path & "\Resources\Interface\FlechaSubirObjeto.jpg") ' www.gs-zone.org
    'CmdMoverBov(0).Picture = LoadPicture(App.path & "\Resources\Interface\FlechaBajarObjeto.jpg") ' www.gs-zone.org
