...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.Path & "\Resources\Interface\VentanaTirarOro.jpg")
...
Private Sub imgTirar_Click()
    If LenB(txtCantidad.Text) > 0 Then
        ...
        If Inventario.SelectedItem = FLAGORO Then
            Inventario.SelectOldItem
            
            If frmCantidad.txtCantidad.Text >= 10000 Then
                Call Audio.PlayWave(SND_BIGGOLD)
            Else
                If frmCantidad.txtCantidad.Text >= 1 And Not frmCantidad.txtCantidad.Text > 1000 And Not frmCantidad.txtCantidad.Text > 10000 Then
                    Call Audio.PlayWave(SND_LOWGOLD)
                Else
                    Call Audio.PlayWave(SND_MIDGOLD)
                End If
            End If
    ...
    Else
        ...
        Else
            ...
            If UserGLD >= 10000 Then
                Call Audio.PlayWave(SND_BIGGOLD)
            Else
                If UserGLD >= 1 And Not UserGLD > 1000 And Not UserGLD > 10000 Then
                    Call Audio.PlayWave(SND_LOWGOLD)
                Else
                    Call Audio.PlayWave(SND_MIDGOLD)
                End If
